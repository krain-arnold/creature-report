...
<body>
	...
	<div class="wrapper">
		<div class="container home-container">
			...
			<div class="white-well" style="background:#fff">
				<img id="logo"
					src="<c:url value="/resources/images/logoSmall.png" />">
				<div class="row-fluid">
					<div class="span10">
						<h3>Thank you !</h3>
							<h5>You have successfully signed up for Creature Report. <br>
								Please use your Username & Password to login and enjoy.
								</h5>
					</div>
